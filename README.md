...
- **Preemptive scheduler** — The EL2 physical timer (`CNTHP_EL2`, PPI 26) drives a 10 ms quantum; on each tick the hypervisor world-switches between vCPUs round-robin. No guest cooperation required (a short quantum keeps cross-core IPI latency low for the SMP Linux guest)
