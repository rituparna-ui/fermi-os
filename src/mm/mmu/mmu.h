...
/* Access Flag — CPU will raise an access fault on first use if AF=0 */
...
/*
 * The MMU is now set up entirely in boot.S (TTBR0 identity map +
 * TTBR1 higher-half map).  The functions below are for later
 * fine-grained mapping via TTBR1 (kernel page tables).
 */
